...
Le produit s'appelle **Xerify**, le paquet distribué sur npm est **`xerify-cli`**, et l'exécutable
installé est **`xerify`**.
...
[Guide Jev](jev.md) · [Couverture des tests et résultats en direct](jev-testing.md) · [Benchmark multi-fournisseurs](benchmark.md)
