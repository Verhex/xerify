...
The product is **Xerify**, the npm distribution is **`xerify-cli`**, and the installed executable
is **`xerify`**.
...
[Jev guide](jev.md) · [Test coverage and live results](jev-testing.md) · [Cross-provider benchmark](benchmark.md)
