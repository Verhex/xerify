...
> Xerify 0.3.0 adds Jev typed decisions alongside LLM verification. A documentation/code consistency check and ten additional live Jev scenarios matched expectations. See the [scenario results](docs/jev-testing.md). This is integration evidence, not a model-accuracy benchmark.
...
[Cross-provider benchmark](docs/benchmark.md)
